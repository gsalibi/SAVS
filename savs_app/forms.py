...
class AnonymousComplaintForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'anonymous_why_anonymous1': forms.CheckboxInput(attrs={"class": "form-control", "onchange": "displayOpenField(this, [4], 'id_anonymous_why_anonymous_complement')"}),
            'anonymous_why_anonymous2': forms.CheckboxInput(attrs={"class": "form-control", "onchange": "displayOpenField(this, [4], 'id_anonymous_why_anonymous_complement')"}),
            'anonymous_why_anonymous3': forms.CheckboxInput(attrs={"class": "form-control", "onchange": "displayOpenField(this, [4], 'id_anonymous_why_anonymous_complement')"}),
            'anonymous_why_anonymous4': forms.CheckboxInput(attrs={"class": "form-control", "onchange": "displayOpenField(this, [4], 'id_anonymous_why_anonymous_complement')"}),
            'anonymous_why_anonymous5': forms.CheckboxInput(attrs={"class": "form-control", "onchange": "displayOpenField(this, [4], 'id_anonymous_why_anonymous_complement')"}),
